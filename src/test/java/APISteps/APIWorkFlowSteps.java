   ...
   // --------------------------------------
    ...
    public void a_request_is_prepared_for_creating_an_employee_with_dynamic_data
        ...
        request = given().
                header(APIConstants.Header_Key_Content_Type, APIConstants.Header_Value_Content_Type).
                header(APIConstants.Header_Key_Authorization, GenerateTokenSteps.token).
                body(APIPayloadConstant.createEmployeePayloadDynamic(firstname, lastname, middlename, gender,
    ...
    public void a_request_is_prepared_for_updating_an_employee() {
        request = given().
                header(APIConstants.Header_Key_Content_Type, APIConstants.Header_Value_Content_Type).
                header(APIConstants.Header_Key_Authorization, GenerateTokenSteps.token).
                body(APIPayloadConstant.updateEmployeePayload());
    }
    ...
    @Then("the response body contains for key {string} and value {string}")
    public void the_response_body_contains_for_key_and_value(String key, String value) {
        response.then().assertThat().body(key,equalTo(value));
    }
...
(String empId, String firstname, String lastname, String middlename,
 ...
 String empStatus, String jobTitle) {
    request = given().
            header(APIConstants.Header_Key_Content_Type, APIConstants.Header_Value_Content_Type).
            header(APIConstants.Header_Key_Authorization, GenerateTokenSteps.token).
            body(APIPayloadConstant.updateEmployeePayloadDynamic(empId, firstname, lastname, middlename, gender,
                    dob, empStatus, jobTitle));
